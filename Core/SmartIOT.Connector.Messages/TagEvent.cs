...
namespace SmartIOT.Connector.Messages
{
    ...
    {
        [ProtoMember(1)] public string DeviceId { get; set; } = string.Empty;
        [ProtoMember(2)] public string TagId { get; set; } = string.Empty;
        [ProtoMember(3)] public int StartOffset { get; set; }
        [ProtoMember(4)] public byte[]? Data { get; set; }
        [ProtoMember(5)] public bool IsInitializationEvent { get; set; }
        [ProtoMember(6)] public int ErrorNumber { get; set; }
