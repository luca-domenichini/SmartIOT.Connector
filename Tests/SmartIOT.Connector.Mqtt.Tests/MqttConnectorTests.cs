    ...
    public class MqttConnectorTests : SmartIOTBaseTests
    {
        ...
        public async Task Test_MqttServerConnector(bool isPublishPartialReads, string serializerType)
        {
            ...
            try
            {
                ...
                await client.SubscribeAsync(new MQTTnet.Client.Subscribing.MqttClientSubscribeOptions
                {
            ...
            finally
            {
                ...
                await client.DisconnectAsync(new MQTTnet.Client.Disconnecting.MqttClientDisconnectOptions()
                {
