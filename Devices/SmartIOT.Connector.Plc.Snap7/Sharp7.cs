...
namespace Sharp7
{
    ...
    public class S7Client
    {
        ...
        #endregion S7DriveES Client Functions
    ...
    public static class S7Nck
    {
        ...
        #endregion Get/Set String (Nck Octet String)
    }

    #endregion [S7 Nck  Help Functions]
